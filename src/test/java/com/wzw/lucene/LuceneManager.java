...
/**
    ...
    public class LuceneManager {
        ...
        public IndexWriter getIndexWriter() {
            try {
                // 获取索引库路径
                Path path = FileSystems.getDefault().getPath("D:\\lucenetest");
                // 创建索引库字典
        ...
        public void delTest() throws IOException {
            IndexWriter writer = getIndexWriter();
            Query query = new TermQuery(new Term("fileName", "中国"));
        ...
        public void update() throws IOException {
            ...
            // 将lucene删除， 然后添加
            writer.updateDocument(new Term("fileName", "china"), document);
            writer.close();
        }
        ...
        public void boolQueryTest() throws IOException {
            ...
            IndexSearcher indexSearcher = getIndexSearcher();
            // 创建查询
            Query query1 = new TermQuery(new Term("fileName", "a.txt"));
            Query query2 = new TermQuery(new Term("fileName", "b.txt"));
            // 构建表达式
        ...
        public void queryParserTest() throws ParseException, IOException {
            ...
            // 此时：表示使用默认域：fileName
            // 查询fileContent域
            Query query = queryParser.parse("fileContent:中国");
            // 打印
            printResult(indexSearcher, query);
            // 关闭资源
            indexSearcher.getIndexReader().close();
